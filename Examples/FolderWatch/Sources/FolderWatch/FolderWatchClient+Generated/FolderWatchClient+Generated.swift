...
struct FolderWatchRuntimeContext: Sendable {
    enum Storage: Sendable {
        case idle(FolderWatchContext)
        case running(FolderWatchContext)
        case stopped(FolderWatchContext)
    }
...
static func idle(_ value: FolderWatchContext) -> Self {
    .init(storage: .idle(value))
}

static func running(_ value: FolderWatchContext) -> Self {
    .init(storage: .running(value))
}

static func stopped(_ value: FolderWatchContext) -> Self {
