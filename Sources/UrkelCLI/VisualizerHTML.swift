...
func generateVisualizerHTML(graph: GraphJSON, machineName: String) -> String {
    let encoder = JSONEncoder()
    let data = try! encoder.encode(graph)
    let json = String(data: data, encoding: .utf8)!
    return buildHTML(graphJSON: json, machineName: machineName)
}

// swiftlint:disable:next function_body_length
private func buildHTML(graphJSON: String, machineName: String) -> String {
    #"""
    <!DOCTYPE html>
    <html lang="en">
    <head>
      ...
      <title>\#(machineName) — Urkel Visualizer</title>
      <style>
    ...
    <body>
      <header>
        <div class="logo">
          ...
          <span class="machine-name" id="machineName">\#(machineName)</span>
